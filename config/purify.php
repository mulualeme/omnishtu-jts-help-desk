    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'div[class],h1[class],h2[class],h3[class],h4[class],h5[class],h6[class],b,strong,i,em,u,a[href|title|target|rel],ul[class],ol[class],li,p[style|class],br,span[style|class],img[width|height|alt|src|style|class],blockquote,table[class|style],tr,td[style],th[style],tbody,thead,video[controls|width|height|src|class],source[src|type],div[class|data-node-type]',
            'HTML.ForbiddenElements' => '',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align,margin,margin-top,margin-bottom,margin-left,margin-right,width,height,display,float',
